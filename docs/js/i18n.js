...
(function(){
  ...
  const DICT = {
    it:{
      ...
      'pascolo.p1':"Tutto inizia dall'erba. Le pecore pascolano libere sui prati dell'azienda: erba diversa, latte diverso. \u00c8 il territorio che ogni giorno entra nel formaggio.",
      'pascolo.p2':"Nessun mangime elaborato, nessuna fretta \u2014 solo ci\u00f2 che la collina offre, stagione dopo stagione, dalla pecora al latte.",
      'metamorfosi.label':'','metamorfosi.title':'La Trasformazione',
      'metamorfosi.p1':'Il latte appena munto incontra il caglio. La cagliata si rompe e si raccoglie a mano. Gesti che non si possono accelerare: ogni forma nasce dalle stesse mani, ogni giorno.',
      ...
      'stagionatura.label':'','stagionatura.title':'La Stagionatura',
      'stagionatura.p1':'Nelle celle le forme riposano per mesi. Girate, spazzolate, accarezzate. Alcune maturano sotto le vinacce, altre tra le erbe: il tempo è un ingrediente.',
      'stagionatura.p2':'È qui, nel silenzio, che il pecorino trova il suo carattere.',
      'tavola.label':'','tavola.title':'La Tavola',
      ...
      'lana.p1':'Le nostre pecore non ci danno solo il latte: ogni anno la tosatura restituisce una lana preziosa, che diventa filato artigianale.',
    ...
    en:{
      ...
      'pascolo.p1':'It all starts with the grass. The sheep graze freely on the farm\'s meadows: different grass, different milk. It is the land that, every day, enters the cheese.',
      'pascolo.p2':'No processed feed, no haste \u2014 only what the hillside offers, season after season, from sheep to milk.',
      'metamorfosi.label':'','metamorfosi.title':'The Transformation',
      'metamorfosi.p1':'Freshly milked, the milk meets the rennet. The curd breaks and is gathered by hand. Gestures that cannot be hurried: every wheel comes from the same hands, every day.',
      ...
      'stagionatura.label':'','stagionatura.title':'The Ageing',
      'stagionatura.p1':'In the cellars the wheels rest for months. Turned, brushed, cared for. Some mature under grape pomace, others among herbs: time is an ingredient.',
      'stagionatura.p2':'It is here, in the silence, that the pecorino finds its character.',
      'tavola.label':'','tavola.title':'The Table',
      ...
      'lana.p1':'Our sheep don\u2019t only give us milk: every year shearing yields a precious wool that becomes artisan yarn.',
