...
(function(){
  ...
  const GALLERY = [
    {src:'assets/imgs/pecorino/ricotta.webp', name:'Ricotta Fresca',
      ...
      scheda:{it:'Ingredienti: Siero di latte | Pezzatura: 400gr, 1500gr | Conservazione: tra 0\u00b0 e 4\u00b0',
              en:'Ingredients: Whey | Size: 400g, 1500g | Storage: 0\u20134\u00b0C'}},
    {src:'assets/imgs/pecorino/fresco.webp', name:'Il Fresco',
      ...
      scheda:{it:'Ingredienti: <strong>Latte crudo di pecora</strong>, caglio naturale di vitello, sale marino | Stagionatura: Circa 1 settimana | Pezzatura: 1,5 kg | Conservazione: tra 4\u00b0 e 9\u00b0',
              en:'Ingredients: <strong>Raw sheep milk</strong>, natural calf rennet, sea salt | Ageing: ~1 week | Size: 1.5 kg | Storage: 4\u20139\u00b0C'}},
    {src:'assets/imgs/pecorino/caciotta.webp', name:'La Caciotta',
      sub:{it:'Pecorino semistagionato',en:'Semi-aged pecorino'},
      desc:{it:"Dal latte lavorato a crudo, nasce la nostra caciotta. \u00c8 un formaggio semplice dal gusto delicato che incontra il favore di grandi e piccini. Riposa per almeno 30 giorni nelle nostre celle, dove matura con una buccia gialla e dorata e una pasta morbida al taglio e ricca al palato.",
            en:"From raw milk comes our caciotta. A simple cheese with a delicate flavour that appeals to young and old alike. It rests for at least 30 days in our cellars, maturing with a golden rind and a paste that is soft to the cut and rich on the palate."},
      scheda:{it:'Ingredienti: <strong>Latte crudo di pecora</strong>, caglio naturale di vitello, sale marino | Stagionatura: Almeno 30gg | Pezzatura: 1,5 kg | Conservazione: tra 0\u00b0 e 4\u00b0 | Disponibilit\u00e0: Tutto l\'anno',
              en:'Ingredients: <strong>Raw sheep milk</strong>, natural calf rennet, sea salt | Ageing: Min. 30 days | Size: 1.5 kg | Storage: 0\u20134\u00b0C | Availability: Year-round'}},
    {src:'assets/imgs/pecorino/appassito.webp', name:"L'Appassito",
      ...
      scheda:{it:'Ingredienti: <strong>Latte crudo di pecora</strong>, caglio naturale di vitello, sale marino | Stagionatura: Circa 30gg | Pezzatura: 350 gr | Conservazione: tra 0\u00b0 e 4\u00b0 | Disponibilit\u00e0: Da dicembre',
              en:'Ingredients: <strong>Raw sheep milk</strong>, natural calf rennet, sea salt | Ageing: ~30 days | Size: 350g | Storage: 0\u20134\u00b0C | Availability: From December'}},
    ...
    {src:'assets/imgs/pecorino/gobbo.webp', name:'Il Gobbo',
      ...
      scheda:{it:'Ingredienti: <strong>Latte crudo di pecora</strong>, caglio vegetale, sale marino | Stagionatura: Circa 60gg | Pezzatura: 1,2 kg | Conservazione: tra 0\u00b0 e 4\u00b0 | Disponibilit\u00e0: Da febbraio',
              en:'Ingredients: <strong>Raw sheep milk</strong>, vegetable rennet, sea salt | Ageing: ~60 days | Size: 1.2 kg | Storage: 0\u20134\u00b0C | Availability: From February'}},
    {src:'assets/imgs/pecorino/noci.webp', name:'Il Noci',
      ...
      scheda:{it:'Ingredienti: <strong>Latte crudo di pecora</strong>, caglio naturale di vitello, sale marino, foglia di noce | Stagionatura: Almeno 100gg | Pezzatura: 1,3 kg | Conservazione: tra 0\u00b0 e 4\u00b0 | Disponibilit\u00e0: Da luglio fino ad esaurimento',
              en:'Ingredients: <strong>Raw sheep milk</strong>, natural calf rennet, sea salt, walnut leaves | Ageing: Min. 100 days | Size: 1.3 kg | Storage: 0\u20134\u00b0C | Availability: From July until sold out'}},
    {src:'assets/imgs/pecorino/castagno.webp', name:'Il Castagno',
      ...
      scheda:{it:'Ingredienti: <strong>Latte crudo di pecora</strong>, caglio naturale di vitello, sale marino, foglia di castagno | Stagionatura: Almeno 100gg | Pezzatura: 1,3 kg | Conservazione: tra 0\u00b0 e 4\u00b0 | Disponibilit\u00e0: Da ottobre fino ad esaurimento',
              en:'Ingredients: <strong>Raw sheep milk</strong>, natural calf rennet, sea salt, chestnut leaves | Ageing: Min. 100 days | Size: 1.3 kg | Storage: 0\u20134\u00b0C | Availability: From October until sold out'}},
    {src:'assets/imgs/pecorino/ubriaco.webp', name:"L'Ubriaco",
      ...
      scheda:{it:'Ingredienti: <strong>Latte crudo di pecora</strong>, caglio naturale di vitello, sale marino, vinaccia di Sangiovese | Stagionatura: Almeno 100gg | Pezzatura: 1,3 kg | Conservazione: tra 0\u00b0 e 4\u00b0 | Disponibilit\u00e0: Da ottobre fino ad esaurimento',
              en:'Ingredients: <strong>Raw sheep milk</strong>, natural calf rennet, sea salt, Sangiovese grape pomace | Ageing: Min. 100 days | Size: 1.3 kg | Storage: 0\u20134\u00b0C | Availability: From October until sold out'}},
    {src:'assets/imgs/pecorino/intenso.webp', name:"L'Intenso",
      ...
      scheda:{it:'Ingredienti: <strong>Latte crudo di pecora</strong>, caglio naturale di vitello, sale marino | Stagionatura: Almeno 150gg | Pezzatura: 1,1 kg | Conservazione: tra 0\u00b0 e 4\u00b0',
              en:'Ingredients: <strong>Raw sheep milk</strong>, natural calf rennet, sea salt | Ageing: Min. 150 days | Size: 1.1 kg | Storage: 0\u20134\u00b0C'}},
    {src:'assets/imgs/pecorino/birrozzo.webp', name:'Il Birrozzo',
      ...
      scheda:{it:'Ingredienti: <strong>Latte crudo di pecora</strong>, caglio naturale di vitello, sale marino, trebbie di birra cruda | Stagionatura: Almeno 100gg | Pezzatura: 1,3 kg | Conservazione: tra 4\u00b0 e 9\u00b0',
              en:'Ingredients: <strong>Raw sheep milk</strong>, natural calf rennet, sea salt, raw beer spent grain | Ageing: Min. 100 days | Size: 1.3 kg | Storage: 4\u20139\u00b0C'}},
    {src:'assets/imgs/pecorino/blu.webp', name:'Il Blu',
      ...
      scheda:{it:'Ingredienti: <strong>Latte crudo di pecora</strong>, caglio naturale, muffe nobili Roqueforti, sale marino | Stagionatura: Almeno 90gg | Pezzatura: 3 kg | Conservazione: tra 4\u00b0 e 9\u00b0',
              en:'Ingredients: <strong>Raw sheep milk</strong>, natural rennet, noble Roquefort moulds, sea salt | Ageing: Min. 90 days | Size: 3 kg | Storage: 4\u20139\u00b0C'}},
    {src:'assets/imgs/pecorino/stagionato.webp', name:'Lo Stagionato',
      ...
      scheda:{it:'Ingredienti: <strong>Latte crudo di pecora</strong>, caglio naturale di vitello, sale marino | Stagionatura: Almeno 12 mesi | Pezzatura: 2,5 kg | Conservazione: tra 4\u00b0 e 9\u00b0',
              en:'Ingredients: <strong>Raw sheep milk</strong>, natural calf rennet, sea salt | Ageing: Min. 12 months | Size: 2.5 kg | Storage: 4\u20139\u00b0C'}},
